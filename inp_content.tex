...
NEUNER Dominik, MSc\\
SCHARMER Alexander, MA, BEd\\
Mag. LANDERER Claudio, Bakk. 
...
Es geht darum, mit dem Handy durch die Gegend zu laufen und an gewissen Standorten Fragen zu beantworten. Für jede richtige\\
Frage gibt es eine gewisse Anzahl an Punkten, abhängig von der Schwierigkeit der Frage. Außerdem sollen jeden Tag, jede Woche,\\ jeden Monat und jedes Jahr ein Highscore berechnet bzw. ausgegeben werden. Der Nutzer den den Highscore hat, bekommt einen\\ Preis.\\
\\
Auf dem Markt gibt es zwar Apps mit ähnlicher Funktion, wie z. B. Pokemon Go, aber keine, bei der man Fragen beantworten muss.\\ 
\\
...
Unser Projekt dient dem Entertainment unserer Kunden. Sie sollen in die Welt (Imst) hinausziehen und dort Fragen\\
 beantworten. Die besten Spieler bekommen am Ende einer Periode (Woche, Monat, Jahr) einen Preis\\
\\
	\item Zielgruppen\\
In erster Linie Gästen, aber auch Einheimischen. Keine Altersbeschränkung\\
\\
	

	\item Hard-/Softwareumgebung\\
Unser Produkt wird es hauptsächlich für Handys und Tablets geben. Vielleicht auch für Computer.\\
...
\begin{itemize}
	...
	\begin{itemize}
		\item Funktional\\
Standorte werden auf realistischer Karte angezeigt, \\
beim Erreichen eines Standortes muss die Frage erscheinen,\\ 
ein Punktestand muss mit gezählt werden,\\
Fragen müssen bearbeitet, hinzugefügt oder gelöscht werden können\\
\\

		\item Nicht-funktional\\
Benutzerfreundlichkeit, \\
Stabilität, \\
keine langen Wartezeiten beim Laden der App, \\
kein hoher Akku Verbrauch, \\
niedrige Systemanforderungen,\\ 
Support muss aufrufbar sein\\
\\
\\
\\
\\
	...
	\begin{itemize}
		\item Funktional\\
alle Punkte jedes Users muss in einer Rangliste aufgezeichnet werden\\
Benachrichtigungen beim Erreichen des 1. bzw. der Top 10 in der Rangliste\\

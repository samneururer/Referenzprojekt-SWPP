...
\subtitle{Fit durch Fortschritt}
...
%\vspace{-30mm}
%\hspace{-4mm}
\includegraphics[height=3cm]{Logo_GeoQuest} % logo
\end{minipage}
...
\begin{tabular}{ l c r }
 Samuel Neururer & Verantwortlich für IT: Programmierung, HTML, CSS \\
 David Urbanz & Verantwortlich für IT: Programmierung, Gestaltung, Design \\
  
  \\\\
\end{tabular}

Eingereicht bei \\
Alexander Scharmer, Claudio Landerer und Dominik Neuner
}